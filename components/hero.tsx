...
//     <section
//       id="home"
//       className="parallax-section relative min-h-screen flex items-center justify-center px-6 py-12 mt-8"
//     >
//       <FloatingParticles />
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="group flex items-center justify-center w-11 h-11 rounded-xl border border-border bg-card/50 backdrop-blur-sm text-muted-foreground transition-all duration-300 hover:text-primary hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5 cursor-pointer"
