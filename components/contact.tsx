...
const contactInfo = [
  {
    ...
    href: "mailto:vanjaragargi@gmail.com",
  },
  {
    icon: Phone,
    title: "Phone",
...
{emailError && (
  ...
  type="submit"
  disabled={loading}
  className="group inline-flex items-center gap-2.5 bg-primary text-primary-foreground px-8 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-0.5 active:translate-y-0 w-full sm:w-auto justify-center disabled:opacity-70 disabled:cursor-not-allowed"
>
